...
def main():
    ...
    # Configuration (single or multi)
        ...
        if args.macaddr:
            ...
            # JFS 10/25/2023 
            # isvalidparameter returns true if it is valid, this line would
            # throw error for every valid parameter
        ...
        for i in range(len(setcmd)):
            ...
            # JFS 10/25/2023
            # isvalidparameter returns True if the parameter is valid, this logic would 
            # always throw the error for a valid parameter
        ...
        if args.all or args.multiset:
            ...
            if args.multiset:
                ...
                # JFS 10/25/2023
                # isvalidparameter returns True if the parameter is valid
                # this would throw an error for every valid parameter
